...
class Routes{
	...
	app.get("/", function(req, res) {
    	res.send("API: <br><br> http://localhost:3000/account" +
		...
		logger.info("\n Novo acesso -> " + Date() +
			'\n *** [Client] User remote address and port ' + req.connection.remoteAddress +':'+ req.connection.remotePort +
			'\n *** [Server] User local  address and port ' + req.connection.localAddress +':'+ req.connection.localPort);
	});
