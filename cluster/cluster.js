...
class Cluster{
    constructor(logger, app, ip, port_server, os, cluster, http){
        ...
        if (cluster.isMaster) {
            ...
            cluster.on('exit', (worker, code, signal) => {
                ...
                app.listen(port_server, ip, function () {
                    logger.info('\nServidor: Listening on http://'+ ip +':'+ port_server +'/');
                });
        } else {     
...
//    console.log(key, cluster.workers[key]);
//});
